...
class StoreTaskRequest extends FormRequest
{
        ...
        return [
            'title' => [
                ...
                function ($attribute, $value, $fail) {
                    ...
                    if ($folderId && Task::where('folder_id', $folderId)
                            ->where('title', $value)
                            ->exists()) {
    ...
    public function messages(): array
    {
        return [
            ...
            'status.in' => 'وضعیت کار باید یکی از موارد todo، in_progress، done یا cancelled باشد',
            'due_date.date' => 'فرمت تاریخ سررسید نامعتبر است',
            'priority.required' => 'اولویت کار الزامی است',
            'priority.in' => 'اولویت کار باید یکی از موارد low، medium، high یا critical باشد',
